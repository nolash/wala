...
fn check_key_bundle(data: &Vec<u8>) -> Option<Cert> {
    match Cert::from_bytes(&data) {
        Ok(v) => {
            //let pubkey = v.primary_key().key();
...
fn check_sig_bundle(public_key: &Cert, signature_data: Vec<u8>, mut message: impl Read, message_length: usize) -> bool {
    ...
    while let PacketParserResult::Some(mut pp) = sig_bundle_packets {
        ...
        sig_bundle_packets = pp.recurse().unwrap().1;
    }
    false
}
...
mod tests { 
    ...
    fn test_pgp_auth_single() {
        ...
        let key_single_hex = "";
        //let key_single_hex = "0462a9f5a916092b06010401da470f0101074061f06baae76d5115553019e50353890e498652fac873d78003e9e192dd9f3e13";
